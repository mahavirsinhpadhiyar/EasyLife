...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasyLife.Financial.Investment.EL_Financial_Investment_Share_Orders", b =>
                {
                    ...
                    b.Property<Guid?>("EL_Financial_Investment_Share_MasterId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("EL_Financial_Investment_Share_MasterId");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("EasyLife.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("EasyLife.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("EasyLife.Financial.Expenses.ExpenseCategory", b =>
                {
                    ...
                    b.Navigation("FKExpenseCategory");
                });
            ...
            modelBuilder.Entity("EasyLife.Financial.Investment.EL_Financial_Investment_Share_Orders", b =>
                {
                    b.HasOne("EasyLife.Financial.Investment.EL_Financial_Investment_Share_Master", null)
                        .WithMany("EL_Financial_Investment_Share_Orders")
                        .HasForeignKey("EL_Financial_Investment_Share_MasterId");
                });
