...
{
    public abstract class EasyLifeWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EasyLifeWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EasyLifeWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EasyLifeDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EasyLifeDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EasyLifeDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EasyLifeDbContext, Task<T>> func)
        {
            T result;
